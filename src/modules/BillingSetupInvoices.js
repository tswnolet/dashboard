...
export const BillingSetupInvoices = () => {
                ...
                {miniNavSelected === 0 ? (
                    <>
                        ...
                        <div className='invoice-template-container'>
                            <Subheader title='Templates' action={<button className='action tertiary'><Plus  size={18} />New Template</button>} />
                            <table className='billing-template-table table-full'>
                                <thead>
                                    <tr>
                                        <th>Template Name</th>
                                        <th>Description</th>
