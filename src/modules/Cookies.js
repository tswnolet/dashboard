...
export default function Cookies() {
  ...
  const [acceptedCookies, setAcceptedCookies] = useState(getCookie('Allow Cookies') != null ? true : false);

  const handleSetCookie = (value) => {
    setCookie('Allow Cookies', value, 365);
          ...
          {!readPolicy ? (
            <>
              ...
              <div className="buttonContainer">
                ...
                <button className="declineButton" onClick={() => handleSetCookie('false')}>Decline</button>
              </div>
            </>
          ) : (
              ...
              <ul>
                {allCookies().map((cookie, index) => (
                  <li key={index}>
                    ...
                    <button className='delete' onClick={() => eraseCookie(cookie.name)}>Delete</button>
                  </li>
                ))}
              </ul>
            </div>
